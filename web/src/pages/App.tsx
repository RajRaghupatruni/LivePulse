  ...
  return (
    <main className="app-shell">
      ...
      <div className="workspace" id="top">
        <section className="welcome-row"><div><span className="eyebrow"><span className="eyebrow-index">01</span> LIVE ENVIRONMENT <i /></span><h1>Stay in the <em>moment.</em></h1><p>Your world, moving in real time.</p></div><div className="welcome-side"><span><span className="pulse-orb" /> CORE SYSTEMS NOMINAL</span><small>EVENT-DRIVEN · DURABLE · RECOVERABLE</small></div></section>
        ...
        <div className="content-grid">
          <div className="primary-column">
            ...
            <div className="system-strip"><div><Activity size={14} /><span>INGESTION</span><strong>SIMULATED PROVIDER</strong></div><div><span className="strip-separator" /><Command size={14} /><span>DELIVERY</span><strong>AT-LEAST-ONCE</strong></div><div><span className="strip-separator" /><Layers3 size={14} /><span>PROJECTION</span><strong>IDEMPOTENT</strong></div><div className="strip-health"><span className="health-tick" /><span>STREAM READY</span></div></div>
          </div>
